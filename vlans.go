...
// VLA***REMOVED***reateOptions fields are those accepted by CreateVLAN
type VLA***REMOVED***reateOptions struct {
...
func (c *Client) CreateVLAN(ctx context.Context, createOpts VLA***REMOVED***reateOptions) (*VLAN, error) {
	var body string
